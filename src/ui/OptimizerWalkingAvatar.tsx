...
function WalkingFrames({ avatar }: { avatar: OptimizerAvatarDescriptor }) {
...
export function OptimizerWalkingAvatar({ avatar }: { avatar: OptimizerAvatarDescriptor }) {
  return <WalkingFrames key={avatar.frames.join('|')} avatar={avatar} />;
}
